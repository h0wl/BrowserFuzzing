...
class Hparams:
    ...
    # train
    ## files
    parser.add_argument('--train1', default='iwslt2016/segmented/train.head.bpe',
                             help="german training segmented data")
    parser.add_argument('--train2', default='iwslt2016/segmented/train.body.bpe',
                             help="english training segmented data")
    parser.add_argument('--eval1', default='iwslt2016/segmented/eval.head.bpe',
                             help="german evaluation segmented data")
    parser.add_argument('--eval2', default='iwslt2016/segmented/eval.body.bpe',
                             help="english evaluation segmented data")
    parser.add_argument('--eval3', default='iwslt2016/segmented/eval.en',
    ...
    parser.add_argument('--maxlen1', default=101, type=int,
    ...
    # test
    parser.add_argument('--test1', default='iwslt2016/segmented/test.head.bpe',
