...
def load_data(fpath1, fpath2, maxlen1, maxlen2):
    ...
    with open(fpath1, 'r') as f1, open(fpath2, 'r') as f2:
        for sent1, sent2 in zip(f1, f2):
            ...
            if len(sents1) == len(sents2) == 200000:
                break
...
def get_batch(fpath1, fpath2, maxlen1, maxlen2, vocab_fpath, batch_size, shuffle):
    ...
    print("dataset size: ", len(sents1), len(sents2))
